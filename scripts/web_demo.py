...
def process_assistant_content(content, is_streaming=False):
    ...
    # stream 생성과 thinking을 함께 쓸 때 처음부터 접힌 영역에 넣습니다.
...
def main():
    ...
    if prompt:
        ...
        sys_prompt = [] if tools else [{"role": "system", "content": "당신은 MiniMind입니다. 친절하고 지식이 풍부한 AI 어시스턴트로서 사용자의 질문에 완전하고 친근하게 답하세요."}]
