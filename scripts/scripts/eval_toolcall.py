...
TOOLS = [
    {"type": "function", "function": {"name": "calculate_math", "description": "수학 표현식을 계산합니다.해당 결과는 덧셈, 뺄셈, 곱셈, 나눗셈, 거듭제곱, 제곱근 등을 지원합니다.", "parameters": {"type": "object", "properties": {"expression": {"type": "string", "description": "수학 표현식. 예: 123+456, 2**10, sqrt(144)"}}, "required": ["expression"]}}},
    {"type": "function", "function": {"name": "get_current_time", "description": "현재 날짜와 시간을 조회합니다. 시간대를 지정할 수 있습니다.", "parameters": {"type": "object", "properties": {"timezone": {"type": "string", "description": "시간대 이름. 예: Asia/Seoul, America/New_York", "default": "Asia/Seoul"}}, "required": []}}},
    ...
    {"type": "function", "function": {"name": "text_length", "description": "텍스트의 문자 수와 단어 수를 계산합니다.", "parameters": {"type": "object", "properties": {"text": {"type": "string", "description": "계산할 텍스트"}}, "required": ["text"]}}},
    {"type": "function", "function": {"name": "unit_converter", "description": "단위를 변환합니다., 길이, 무게, 온도 등을 지원합니다.", "parameters": {"type": "object", "properties": {"value": {"type": "number", "description": "변환할 값"}, "from_unit": {"type": "string", "description": "원본 단위. 예: km, miles, kg, pounds, celsius, fahrenheit"}, "to_unit": {"type": "string", "description": "목표 단위"}}, "required": ["value", "from_unit", "to_unit"]}}},
    {"type": "function", "function": {"name": "get_current_weather", "description": "지정한 도시의 현재 날씨 정보를 조회합니다.", "parameters": {"type": "object", "properties": {"location": {"type": "string", "description": "도시 이름. 예: 서울, 부산, New York"}, "unit": {"type": "string", "description": "온도 단위. celsius 또는 fahrenheit", "enum": ["celsius", "fahrenheit"], "default": "celsius"}}, "required": ["location"]}}},
    {"type": "function", "function": {"name": "get_exchange_rate", "description": "두 통화 사이의 환율을 조회합니다.", "parameters": {"type": "object", "properties": {"from_currency": {"type": "string", "description": "원본 통화 코드. 예: USD, KRW, EUR"}, "to_currency": {"type": "string", "description": "목표 통화 코드. 예: USD, KRW, EUR"}}, "required": ["from_currency", "to_currency"]}}},
    {"type": "function", "function": {"name": "translate_text", "description": "텍스트를 목표 언어로 번역합니다.", "parameters": {"type": "object", "properties": {"text": {"type": "string", "description": "번역할 텍스트"}, "target_language": {"type": "string", "description": "목표 언어. 예: english, korean, japanese, french"}}, "required": ["text", "target_language"]}}},
]
...
TEST_CASES = [
    {"prompt": "256에 37을 곱하면 얼마인지 계산하는 것을 도와주세요.", "tools": ["calculate_math", "get_current_time"]},
    {"prompt": "지금 몇 시예요?", "tools": ["get_current_time", "random_number"]},
    {"prompt": "100킬로미터를 마일로 환산해 주세요.", "tools": ["unit_converter", "calculate_math"]},
    {"prompt": "1부터 1000 사이의 숫자를 생성한 다음, 그 숫자의 제곱을 계산하세요.", "tools": ["random_number", "calculate_math", "text_length"]},
    {"prompt": "서울 오늘 날씨 어때요?", "tools": ["get_current_weather", "get_current_time"]},
    {"prompt": "미 달러/중국 위안 환율을 확인하세요.", "tools": ["get_exchange_rate", "get_current_time"]},
    {"prompt": "안녕하세요'를 영어로 바꾸세요", "tools": ["translate_text", "text_length"]},
