...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_medical", help="LoRA 가중치 이름")
    ...
    # ========== 5. 모델 정의, LoRA 적용, 비-LoRA 파라미터 freeze ==========
    ...
    if args.use_compile == 1:
        args.use_compile = 0
        Logger('[LoRA] monkey-patch forward 은 torch.compile과 호환되지 않아 use_compile을 자동으로 껐습니다.')
