...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='full_sft', type=str, help="저장할 가중치 이름")
    ...
    parser.add_argument('--from_weight', default='pretrain', type=str, help="어떤 가중치에서 시작할지 지정합니다.")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Full-SFT", help="wandb 프로젝트 이름")
